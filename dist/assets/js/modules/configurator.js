function configurator(){
      ...
      const linkButton = document.querySelector('#config__inner');
        ...
        linkButton.addEventListener('click',()=>{
            ...
            if (linkButton.getAttribute('data-ssdtitle')!='') {
                ...
                dbState.ssd.price = +linkButton.getAttribute('data-essdrice');
            ...
            if (linkButton.getAttribute('data-hddtitle')!='') {
                ...
                dbState.hdd.price = +linkButton.getAttribute('data-ehddrice');
    ...
    function totalConfig(){
        ...
        totalCart.setAttribute('data-body', dbState.body.title);
        totalCart.setAttribute('data-video', dbState.video.title);
        totalCart.setAttribute('data-proc', dbState.proc.title);
        totalCart.setAttribute('data-mat', dbState.mat.title);
        totalCart.setAttribute('data-ram', dbState.ram.title);
        totalCart.setAttribute('data-ramQuant', dbState.ram.quantity);
        totalCart.setAttribute('data-ssd', dbState.ssd.title);
        totalCart.setAttribute('data-ssd2', dbState.ssd2.title);
        totalCart.setAttribute('data-energy', dbState.energy.title);
        totalCart.setAttribute('data-cool', dbState.cool.title);
        totalCart.setAttribute('data-wifi', dbState.wifi.title);
        totalCart.setAttribute('data-dvd', dbState.dvd.title);
        totalCart.setAttribute('data-sound', dbState.sound.title);
        totalCart.setAttribute('data-os', dbState.os.title);
    }
