...
/* harmony import */ var just_validate_dist_js_just_validate_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! just-validate/dist/js/just-validate.min.js */ "./node_modules/just-validate/dist/js/just-validate.min.js");
/* harmony import */ var just_validate_dist_js_just_validate_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(just_validate_dist_js_just_validate_min_js__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _modules_filter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/filter */ "./app/assets/js/modules/filter.js");
/* harmony import */ var _modules_tabs_my__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/tabs-my */ "./app/assets/js/modules/tabs-my.js");
/* harmony import */ var _modules_cart__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/cart */ "./app/assets/js/modules/cart.js");
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/modal */ "./app/assets/js/modules/modal.js");
/* harmony import */ var _modules_burger__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/burger */ "./app/assets/js/modules/burger.js");
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/service */ "./app/assets/js/services/service.js");
/* harmony import */ var _modules_scroll__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/scroll */ "./app/assets/js/modules/scroll.js");
/* harmony import */ var _modules_configurator__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/configurator */ "./app/assets/js/modules/configurator.js");
...
document.addEventListener('DOMContentLoaded', () => {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-slider__inner').slick({
    infinite: true,
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: true,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.item-photo-slider').slick({
    infinite: true,
    slidesToShow: 3,
    slidesToScroll: 1,
    arrows: true,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.config-result__slide').on('click', () => {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.config-result__total-list').slideToggle();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.config-result__slide').toggleClass('rotate-arrow');
  });

  try {
    document.querySelectorAll('.config-tabs__buttons').forEach(el => {
      new simplebar__WEBPACK_IMPORTED_MODULE_3__["default"](el);
    });
  } catch (e) {}

  try {
    Object(_modules_tabs_my__WEBPACK_IMPORTED_MODULE_5__["FPS"])();
    Object(_modules_tabs_my__WEBPACK_IMPORTED_MODULE_5__["tabs"])(".tabs-items__item", ".tabs-button__item", ".tabs-button__inner", ".tabs-button--active");
  } catch (e) {
    console.log('tabs, FPS');
  }

  try {
    Object(_modules_tabs_my__WEBPACK_IMPORTED_MODULE_5__["tabs"])(".config-tabs__content-items", ".config-tabs__buttons button", ".config-tabs__buttons", ".config-btn__active", false);
  } catch (e) {
    console.log('tabs');
  }

  try {
    Object(_modules_filter__WEBPACK_IMPORTED_MODULE_4__["makeFilterButton"])();
  } catch (e) {}
  ...
  try {
    Object(_modules_modal__WEBPACK_IMPORTED_MODULE_7__["modal"])(".pop-cart", ".modal-universal__close img", ".header-cart", ".pop-cart__inner");
  } catch (e) {
    console.log('modal1');
  }

  try {
    Object(_modules_modal__WEBPACK_IMPORTED_MODULE_7__["modal"])(".modal-config", ".modal-universal__close img", ".content-list__item-info", ".modal-config__wrapper", '.modal-config__inner', '.content-list__item', true);
  } catch (e) {
    console.log('modal2');
  }
  ...
  try {
    Object(_services_service__WEBPACK_IMPORTED_MODULE_9__["calcHeight"])('.configurator__table-list', '.configurator__content', 750);
  } catch (e) {
    console.log('calcHeight');
  }

  try {
    Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_10__["scrollConfig"])();
  } catch (e) {
    console.log('scroll');
  }

  try {
    Object(_modules_configurator__WEBPACK_IMPORTED_MODULE_11__["configurator"])();
  } catch (e) {
    console.log('config');
  }
});
...
/***/ "./app/assets/js/modules/burger.js":
/*!*****************************************!*\
  !*** ./app/assets/js/modules/burger.js ***!
  \*****************************************/
...
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/service */ "./app/assets/js/services/service.js");
...
function cart() {
  ...
  function cartInit() {
    Object(_services_service__WEBPACK_IMPORTED_MODULE_1__["maskTel"])('input[type = "tel"]');
    updateCart(dataMas);
  ...
  cartInit();
  Object(_services_service__WEBPACK_IMPORTED_MODULE_1__["validateForms"])('.pop-cart__content', {
    name: {
      required: true
    },
    tel: {
  ...
  }, '.test', 'send goal', dataMas, updateCart);
}
...
/***/ "./app/assets/js/modules/configurator.js":
/*!***********************************************!*\
  !*** ./app/assets/js/modules/configurator.js ***!
  \***********************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "configurator", function() { return configurator; });
/* harmony import */ var core_js_modules_es_string_replace_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.string.replace.js */ "./node_modules/core-js/modules/es.string.replace.js");
/* harmony import */ var core_js_modules_es_string_replace_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_replace_js__WEBPACK_IMPORTED_MODULE_0__);
...
/***/ "./app/assets/js/modules/filter.js":
/*!*****************************************!*\
  !*** ./app/assets/js/modules/filter.js ***!
  \*****************************************/
/*! exports provided: makeFilterButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeFilterButton", function() { return makeFilterButton; });
...
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/service */ "./app/assets/js/services/service.js");
...
function modal(selector, selectorClose, selectorBtn, selectorInner, selectorContent = "", selectorData = "", triggerCreate = false) {
  ...
  modalBtn.forEach(item => {
    item.addEventListener("click", e => {
      if (triggerCreate) {
        Object(_services_service__WEBPACK_IMPORTED_MODULE_0__["modalCreate"])(selectorContent, selectorData, e.target);
...
/***/ "./app/assets/js/modules/scroll.js":
/*!*****************************************!*\
  !*** ./app/assets/js/modules/scroll.js ***!
  \*****************************************/
/*! exports provided: scrollConfig */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollConfig", function() { return scrollConfig; });
/* harmony import */ var core_js_modules_es_string_replace_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.string.replace.js */ "./node_modules/core-js/modules/es.string.replace.js");
/* harmony import */ var core_js_modules_es_string_replace_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_replace_js__WEBPACK_IMPORTED_MODULE_0__);
...
function scrollConfig() {
  ...
  function moveElement(elem) {
    let koordWin = wrapperScroll.getBoundingClientRect().top - 150,
    ...
    let winTop = document.body.scrollTop,
        ...
        winBlock = koordBlock,
        winScrollBottom = wrapperScroll.scrollHeight - wrapperScroll.scrollTop - wrapperScroll.clientHeight;
    ...
    function step(time) {
      ...
      if (r != widthTop + toBlock) {
        requestAnimationFrame(step);
      } else {// winBlock = elem.getBoundingClientRect().top;
        // requestAnimationFrame(win);
      }
    }
...
/***/ "./app/assets/js/modules/tabs-my.js":
/*!******************************************!*\
  !*** ./app/assets/js/modules/tabs-my.js ***!
  \******************************************/
/*! exports provided: FPS, tabs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function FPS() {
  ...
  fpsValue.forEach(item => {
    let fpsPosition = Math.trunc(+item.getAttribute("data-position") / 350 * 100);
...
function tabs(tabsSelector, tabsBtnSelector, tabsParrentSelector, tabActiveSelector, triggerTabs = true) {
  ...
  if (triggerTabs) {
    ...
    const parrentTabs = document.querySelectorAll('.configurator__content-item');
...
/***/ "./app/assets/js/services/service.js":
/*!*******************************************!*\
  !*** ./app/assets/js/services/service.js ***!
  \*******************************************/
/*! exports provided: calcHeight, modalCreate, maskTel, validateForms */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calcHeight", function() { return calcHeight; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalCreate", function() { return modalCreate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "maskTel", function() { return maskTel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validateForms", function() { return validateForms; });
...
/* harmony import */ var just_validate_dist_js_just_validate_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! just-validate/dist/js/just-validate.min.js */ "./node_modules/just-validate/dist/js/just-validate.min.js");
/* harmony import */ var just_validate_dist_js_just_validate_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(just_validate_dist_js_just_validate_min_js__WEBPACK_IMPORTED_MODULE_1__);
...
function maskTel(selectorInput) {
  ...
  let im = new inputmask__WEBPACK_IMPORTED_MODULE_0___default.a('+7 (999) 999-99-99');
  im.mask(selectorTel);
}
